...
* *Unit3.* AngularJS framework in depth. Introducing Test-Driven Development in JavaScript. Creating test scripts for models, views, controllers with Jasmine.js. Creating the second prototype of the UI. Build automation with Grunt. Package Management with Bower.
