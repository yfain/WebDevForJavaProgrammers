...
* *Unit 3.* AngularJS framework in depth. Creating the second prototype of the UI. Build automation with Grunt. Package Management with Bower. Here's link:timeline.adoc#unit-3[the timeline] for this lesson.
